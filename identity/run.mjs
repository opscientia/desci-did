...
/////////////////////////////////////////
// Differences start. runtime interaction here

// Create the model and store
const model = new DataModel({ ceramic, model: modelAliases })
const store = new DIDDataStore({ ceramic, model })

// get previously written tile
const exampleID = await model.loadTile("exampleID")
console.log("exampleID object:")
console.dir(exampleID)

///////////////////////////////////
// new note creation
// const newID = await model.createTile("")
